...
export default function UserStatistics() {
  ...
  return (
    <div className="flex h-auto flex-col items-center justify-center border-4 border-preto-default bg-branco p-8 shadow-default-preto md:min-w-[25rem] gap-3">
      <h2 className="center text-2xl font-bold text-laranja uppercase p-5 border border-laranja bg-[#f8e0c9]/60">estatísticas</h2>
